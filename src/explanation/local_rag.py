...
class BatteryRAG:
    ...
    def _format_prompt(
        ...
        return (
            ...
            "2. Be concise and technical — the reader is an engineer or researcher.\n"
            "3. Cite which document supports each claim.\n"
            "4. If the information is not in the documents, say so explicitly.\n\n"
            "ANSWER:"
        )
